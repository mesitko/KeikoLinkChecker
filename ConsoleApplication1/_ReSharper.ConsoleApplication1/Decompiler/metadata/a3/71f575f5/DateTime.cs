...
namespace System
{
  ...
  public struct DateTime : IComparable, IFormattable, IConvertible, ISerializable, IComparable<DateTime>, IEquatable<DateTime>
  {
    ...
    /// </returns>
    /// <param name="d1">The date and time value to subtract from (the minuend). </param><param name="d2">The date and time value to subtract (the subtrahend). </param><filterpriority>3</filterpriority>
    ...
    /// </returns>
    /// <param name="d1">The first object to compare. </param><param name="d2">The second object to compare. </param><filterpriority>3</filterpriority>
    ...
    public static bool operator !=(DateTime d1, DateTime d2);
    /// <summary>
    /// Determines whether one specified <see cref="T:System.DateTime"/> is earlier than another specified <see cref="T:System.DateTime"/>.
    /// </summary>
    /// 
    /// <returns>
    /// true if <paramref name="t1"/> is earlier than <paramref name="t2"/>; otherwise, false.
    /// </returns>
    /// <param name="t1">The first object to compare. </param><param name="t2">The second object to compare. </param><filterpriority>3</filterpriority>
    public static bool operator <(DateTime t1, DateTime t2);
    /// <summary>
    /// Determines whether one specified <see cref="T:System.DateTime"/> represents a date and time that is the same as or earlier than another specified <see cref="T:System.DateTime"/>.
    /// </summary>
    /// 
    /// <returns>
    /// true if <paramref name="t1"/> is the same as or earlier than <paramref name="t2"/>; otherwise, false.
    /// </returns>
    /// <param name="t1">The first object to compare. </param><param name="t2">The second object to compare. </param><filterpriority>3</filterpriority>
    public static bool operator <=(DateTime t1, DateTime t2);
    /// <summary>
    /// Determines whether one specified <see cref="T:System.DateTime"/> is later than another specified <see cref="T:System.DateTime"/>.
    /// </summary>
    /// 
    /// <returns>
    ...
    public static bool operator >(DateTime t1, DateTime t2);
    /// <summary>
    /// Determines whether one specified <see cref="T:System.DateTime"/> represents a date and time that is the same as or later than another specified <see cref="T:System.DateTime"/>.
    /// </summary>
    /// 
    /// <returns>
    /// true if <paramref name="t1"/> is the same as or later than <paramref name="t2"/>; otherwise, false.
    /// </returns>
    /// <param name="t1">The first object to compare. </param><param name="t2">The second object to compare. </param><filterpriority>3</filterpriority>
    public static bool operator >=(DateTime t1, DateTime t2);
    /// <summary>
    ...
    /// </returns>
    /// <param name="t1">The first object to compare. </param><param name="t2">The second object to compare. </param><filterpriority>1</filterpriority>
    ...
    /// </returns>
    /// <param name="value">A boxed object to compare, or null. </param><exception cref="T:System.ArgumentException"><paramref name="value"/> is not a <see cref="T:System.DateTime"/>. </exception><filterpriority>2</filterpriority>
    ...
    /// </returns>
    /// <param name="value">The object to compare to the current instance. </param><filterpriority>2</filterpriority>
    ...
    /// </returns>
    /// <param name="value">The object to compare to this instance. </param><filterpriority>2</filterpriority>
    ...
    /// 
    /// <returns>
    /// An object that is equivalent to the <see cref="T:System.DateTime"/> object that was serialized by the <see cref="M:System.DateTime.ToBinary"/> method.
    /// </returns>
    ...
    /// 
    /// <returns>
    /// An object that represents the UTC time equivalent of the date and time represented by the <paramref name="fileTime"/> parameter.
    /// </returns>
    /// <param name="fileTime">A Windows file time expressed in ticks. </param><exception cref="T:System.ArgumentOutOfRangeException"><paramref name="fileTime"/> is less than 0 or represents a time greater than <see cref="F:System.DateTime.MaxValue"/>. </exception><filterpriority>1</filterpriority>
    ...
    /// </summary>
    /// <param name="info">The object to populate with data. </param><param name="context">The destination for this serialization. (This parameter is not used; specify null.)</param><exception cref="T:System.ArgumentNullException"><paramref name="info"/> is null.</exception>
    [SecurityCritical]
    ...
    /// <summary>
    /// Converts the string representation of a date and time to its <see cref="T:System.DateTime"/> equivalent.
    /// </summary>
    /// 
    /// <returns>
    ...
    /// 
    /// <returns>
    /// An object that is equivalent to the date and time contained in <paramref name="s"/> as specified by <paramref name="provider"/>.
    /// </returns>
    ...
    /// <summary>
    /// Converts the string representation of a date and time to its <see cref="T:System.DateTime"/> equivalent by using culture-specific format information and formatting style.
    /// </summary>
    /// 
    /// <returns>
    /// An object that is equivalent to the date and time contained in <paramref name="s"/>, as specified by <paramref name="provider"/> and <paramref name="styles"/>.
    /// </returns>
    ...
    /// 
    /// <returns>
    /// A time interval that is equal to the date and time represented by this instance minus the date and time represented by <paramref name="value"/>.
    /// </returns>
    /// <param name="value">The date and time value to subtract. </param><exception cref="T:System.ArgumentOutOfRangeException">The result is less than <see cref="F:System.DateTime.MinValue"/> or greater than <see cref="F:System.DateTime.MaxValue"/>. </exception><filterpriority>2</filterpriority>
    ...
    /// 
    /// <returns>
    /// An object that is equal to the date and time represented by this instance minus the time interval represented by <paramref name="value"/>.
    /// </returns>
    /// <param name="value">The time interval to subtract. </param><exception cref="T:System.ArgumentOutOfRangeException">The result is less than <see cref="F:System.DateTime.MinValue"/> or greater than <see cref="F:System.DateTime.MaxValue"/>. </exception><filterpriority>2</filterpriority>
    ...
    /// </returns>
    /// <exception cref="T:System.ArgumentOutOfRangeException">The date and time is outside the range of dates supported by the calendar used by the current culture. </exception><filterpriority>1</filterpriority>
    ...
    /// </returns>
    /// <param name="provider">An object that supplies culture-specific formatting information. </param><exception cref="T:System.ArgumentOutOfRangeException">The date and time is outside the range of dates supported by the calendar used by <paramref name="provider"/>. </exception><filterpriority>1</filterpriority>
    ...
    /// 
    /// <returns>
    /// A string array where each element is the representation of the value of this instance formatted with the <paramref name="format"/> standard date and time format specifier.
    /// </returns>
    /// <param name="format">A standard date and time format string (see Remarks). </param><exception cref="T:System.FormatException"><paramref name="format"/> is not a valid standard date and time format specifier character.</exception><filterpriority>2</filterpriority>
    ...
    /// </returns>
    /// <filterpriority>1</filterpriority>
    public static DateTime UtcNow { [SecuritySafeCritical] get; }
    /// <summary>
